...
def save_s3_output(segments, disp_pos, cdisp_pos, cdisp_widths, moved_ints, outfiles, outdir):
    ...
    Args:
        ...
        disp_pos (list): dispersion/x positions. Could be an empty list.
        cdisp_pos (list): cross-dispersion/y positions. Could be an empty list.
        cdisp_widths (list): cross-dispersion widths/psf fwhms. Could be an empty list.
